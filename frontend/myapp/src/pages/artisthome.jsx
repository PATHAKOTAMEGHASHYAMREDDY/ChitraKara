...
function Artisthome() {
  ...
  useEffect(() => {
    const fetchCustomRequests = async () => {
      try {
        const response = await axios.get(`https://chitra-kara-api.vercel.app/api/customrequests/${username}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://chitra-kara-api.vercel.app/api/uploadpainting", formData, {
  ...
  const handleAcceptRequest = async (requestId) => {
    try {
      const response = await axios.put(`https://chitra-kara-api.vercel.app/api/customrequests/${requestId}`, {
        status: "accepted",
      });
